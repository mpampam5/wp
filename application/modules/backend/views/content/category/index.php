      ...
      <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/category/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
...
$(document).ready(function() {
      $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      {
        ...
        var t = $("#table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?=base_url()?>backend/category/json", "type": "POST"},
            columns: [
                {
                    "data": "id_category",
                    "orderable": false
