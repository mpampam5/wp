      ...
      <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/media_video/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
...
$(document).ready(function() {
      $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      {
        ...
        var t = $("#table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?=base_url()?>backend/media_video/json", "type": "POST"},
            columns: [
                {
                    "data": "id",
                    "orderable": false
                  ...
                  {
                    return '<a data-fancybox="gallery" class="text-info" title="'+data+'" href="'+data+'">'+data.substr(0, 36)+'...</a>';
                  }
                },
                {
                    "data" : "action",
