...
<section class="breadcrumbs">
  <div class="container">
    <ol class="breadcrumb">
      ...
      <li><a href="<?=site_url('backend/news')?>"><?=ucfirst($temp_title)?></a></li>
    ...
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <div class="card">
            ...
            <form action="<?=$action?>" id="form" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <?=cmb_query("id_category","id_category","SELECT * FROM category WHERE category.delete='0'","id_category","category",$id_category)?>
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <a href="<?=base_url()?>temp/img_manager/news/<?=$image?>" data-fancybox="gallery" id="text-img" class="form-control text-info"><?=$image?></a>
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="desc" name="description" placeholder="Description"><?=$description?></textarea>
