      ...
      <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/media_foto/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
...
$(document).ready(function() {
      $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      {
        ...
        var t = $("#table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?=base_url()?>backend/media_foto/json", "type": "POST"},
            columns: [
                {
                    "data": "id",
                    "orderable": false
                  ...
                  {
                    var str='<a href="<?=base_url()?>temp/img_manager/media_foto/'+data+'" data-fancybox="gallery"><div class="img-media" style="background:url(<?=base_url()?>temp/img_manager/media_foto/thumbs/'+data+')"></div></a>';
                    return str;
                  }
                },
                {
